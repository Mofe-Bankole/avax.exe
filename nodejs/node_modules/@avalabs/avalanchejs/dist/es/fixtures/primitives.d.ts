...
import { BigIntPr, Bool, Byte, Bytes, Int, Short, Stringpr } from '../serializable/primitives';
...
export declare const boolBytes: (val?: boolean) => Uint8Array;
export declare const bool: (val?: boolean) => Bool;
...
export declare const blsPublicKey: () => BlsPublicKey;
