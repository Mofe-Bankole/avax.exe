 ...
 * ```
 */
export declare function buildUtxoBytes(txHash: string, outputIndex: number, assetId: string, amount: string, addresses: string[], locktime: string, threshold: number, stakeableLocktime?: string): `0x${string}`;
