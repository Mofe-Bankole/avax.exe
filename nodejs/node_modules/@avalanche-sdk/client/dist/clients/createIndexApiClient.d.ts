 ...
 * ```
 */
export declare function createIndexApiClient<transport extends Transport, chain extends Chain | undefined = undefined, accountOrAddress extends Account | Address | undefined = undefined, rpcSchema extends RpcSchema | undefined = undefined, raw extends boolean = false>(parameters: IndexApiClientConfig<transport, chain, accountOrAddress, rpcSchema, raw>): IndexApiClient<transport, chain, ParseAccount<accountOrAddress>, rpcSchema>;
//# sourceMappingURL=createIndexApiClient.d.ts.map