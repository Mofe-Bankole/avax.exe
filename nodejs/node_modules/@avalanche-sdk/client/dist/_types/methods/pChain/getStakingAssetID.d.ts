 ...
 * ```
 */
export declare function getStakingAssetID<chain extends Chain | undefined>(client: Client<Transport, chain>, params: GetStakingAssetIDParameters): Promise<GetStakingAssetIDReturnType>;
//# sourceMappingURL=getStakingAssetID.d.ts.map