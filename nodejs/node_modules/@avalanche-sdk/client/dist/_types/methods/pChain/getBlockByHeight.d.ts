 ...
 * ```
 */
export declare function getBlockByHeight<chain extends Chain | undefined>(client: Client<Transport, chain>, params: GetBlockByHeightParameters): Promise<GetBlockByHeightReturnType>;
//# sourceMappingURL=getBlockByHeight.d.ts.map