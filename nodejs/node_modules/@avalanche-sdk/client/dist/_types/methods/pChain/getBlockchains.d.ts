 ...
 * ```
 */
export declare function getBlockchains<chain extends Chain | undefined>(client: Client<Transport, chain>): Promise<GetBlockchainsReturnType>;
//# sourceMappingURL=getBlockchains.d.ts.map