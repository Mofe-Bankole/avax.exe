 ...
 * ```
 */
export declare function getCurrentSupply<chain extends Chain | undefined>(client: Client<Transport, chain>, params: GetCurrentSupplyParameters): Promise<GetCurrentSupplyReturnType>;
//# sourceMappingURL=getCurrentSupply.d.ts.map