 ...
 * ```
 */
export declare function getRewardUTXOs<chain extends Chain | undefined>(client: Client<Transport, chain>, params: GetRewardUTXOsParameters): Promise<GetRewardUTXOsReturnType>;
//# sourceMappingURL=getRewardUTXOs.d.ts.map