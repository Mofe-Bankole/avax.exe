 ...
 * ```
 */
export declare function getValidatorsAt<chain extends Chain | undefined>(client: Client<Transport, chain>, params: GetValidatorsAtParameters): Promise<GetValidatorsAtReturnType>;
//# sourceMappingURL=getValidatorsAt.d.ts.map