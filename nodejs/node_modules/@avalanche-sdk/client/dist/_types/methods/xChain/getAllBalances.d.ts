 ...
 * ```
 */
export declare function getAllBalances<chain extends Chain | undefined>(client: Client<Transport, chain>, params: GetAllBalancesParameters): Promise<GetAllBalancesReturnType>;
