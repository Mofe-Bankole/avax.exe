 ...
 * ```
 */
export declare function getAssetDescription<chain extends Chain | undefined>(client: Client<Transport, chain>, params: GetAssetDescriptionParameters): Promise<GetAssetDescriptionReturnType>;
