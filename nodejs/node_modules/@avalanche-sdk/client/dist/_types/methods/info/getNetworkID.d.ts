 ...
 * ```
 */
export declare function getNetworkID<chain extends Chain | undefined>(client: Client<Transport, chain>): Promise<GetNetworkIDReturnType>;
//# sourceMappingURL=getNetworkID.d.ts.map