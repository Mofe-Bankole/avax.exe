...
import { IsBootstrappedParameters, IsBootstrappedReturnType } from "./types/isBootstrapped.js";
/**
 ...
 * ```
 */
export declare function isBootstrapped<chain extends Chain | undefined>(client: Client<Transport, chain>, params: IsBootstrappedParameters): Promise<IsBootstrappedReturnType>;
