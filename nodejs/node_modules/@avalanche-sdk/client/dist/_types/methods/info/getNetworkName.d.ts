 ...
 * ```
 */
export declare function getNetworkName<chain extends Chain | undefined>(client: Client<Transport, chain>): Promise<GetNetworkNameReturnType>;
//# sourceMappingURL=getNetworkName.d.ts.map