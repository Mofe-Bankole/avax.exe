 ...
 * ```
 */
export declare function getNodeIP<chain extends Chain | undefined>(client: Client<Transport, chain>): Promise<GetNodeIPReturnType>;
//# sourceMappingURL=getNodeIP.d.ts.map