 ...
 * ```
 */
export declare function getProposedHeight<chain extends Chain | undefined>(client: Client<Transport, chain>): Promise<GetProposedHeightReturnType>;
//# sourceMappingURL=getProposedHeight.d.ts.map