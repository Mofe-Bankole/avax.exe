 ...
 * ```
 */
export declare function loadVMs<chain extends Chain | undefined>(client: Client<Transport, chain>): Promise<LoadVMsReturnType>;
//# sourceMappingURL=loadVMs.d.ts.map