 ...
 * ```
 */
export declare function maxPriorityFeePerGas<chain extends Chain | undefined>(client: Client<Transport, chain>): Promise<MaxPriorityFeePerGasReturnType>;
//# sourceMappingURL=maxPriorityFeePerGas.d.ts.map