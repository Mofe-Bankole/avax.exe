...
import { GetAllValidatorsAtParameters, GetAllValidatorsAtReturnType } from "../../methods/pChain/types/getAllValidatorsAt.js";
import { GetBalanceParameters, GetBalanceReturnType } from "../../methods/pChain/types/getBalance.js";
import { GetBlockParameters, GetBlockReturnType } from "../../methods/pChain/types/getBlock.js";
import { GetBlockByHeightParameters, GetBlockByHeightReturnType } from "../../methods/pChain/types/getBlockByHeight.js";
import { GetBlockchainsReturnType } from "../../methods/pChain/types/getBlockchains.js";
import { GetBlockchainStatusParameters, GetBlockchainStatusReturnType } from "../../methods/pChain/types/getBlockchainStatus.js";
import { GetCurrentSupplyParameters, GetCurrentSupplyReturnType } from "../../methods/pChain/types/getCurrentSupply.js";
import { GetCurrentValidatorsParameters, GetCurrentValidatorsReturnType } from "../../methods/pChain/types/getCurrentValidators.js";
...
import { GetL1ValidatorParameters, GetL1ValidatorReturnType } from "../../methods/pChain/types/getL1Validator.js";
import { GetMinStakeParameters, GetMinStakeReturnType } from "../../methods/pChain/types/getMinStake.js";
import { GetProposedHeightReturnType } from "../../methods/pChain/types/getProposedHeight.js";
import { GetRewardUTXOsParameters, GetRewardUTXOsReturnType } from "../../methods/pChain/types/getRewardUTXOs.js";
import { GetStakeParameters, GetStakeReturnType } from "../../methods/pChain/types/getStake.js";
import { GetStakingAssetIDParameters, GetStakingAssetIDReturnType } from "../../methods/pChain/types/getStakingAssetID.js";
import { GetSubnetParameters, GetSubnetReturnType } from "../../methods/pChain/types/getSubnet.js";
import { GetSubnetsParameters, GetSubnetsReturnType } from "../../methods/pChain/types/getSubnets.js";
import { GetTimestampReturnType } from "../../methods/pChain/types/getTimestamp.js";
import { GetTotalStakeParameters, GetTotalStakeReturnType } from "../../methods/pChain/types/getTotalStake.js";
import { GetTxParameters, GetTxReturnType } from "../../methods/pChain/types/getTx.js";
import { GetTxStatusParameters, GetTxStatusReturnType } from "../../methods/pChain/types/getTxStatus.js";
import { GetUTXOsParameters, GetUTXOsReturnType } from "../../methods/pChain/types/getUTXOs.js";
import { GetValidatorsAtParameters, GetValidatorsAtReturnType } from "../../methods/pChain/types/getValidatorsAt.js";
import { IssueTxParameters, IssueTxReturnType } from "../../methods/pChain/types/issueTx.js";
import { SampleValidatorsParameters, SampleValidatorsReturnType } from "../../methods/pChain/types/sampleValidators.js";
import { ValidatedByParameters, ValidatedByReturnType } from "../../methods/pChain/types/validatedBy.js";
import { ValidatesParameters, ValidatesReturnType } from "../../methods/pChain/types/validates.js";
...
export type PChainActions = {
     ...
     * ```
     */
    getAllValidatorsAt: (args: GetAllValidatorsAtParameters) => Promise<GetAllValidatorsAtReturnType>;
    /**
...
export declare function pChainActions<chain extends Chain | undefined = Chain | undefined>(client: AvalancheCoreClient<Transport, chain>): PChainActions;
//# sourceMappingURL=pChain.d.ts.map