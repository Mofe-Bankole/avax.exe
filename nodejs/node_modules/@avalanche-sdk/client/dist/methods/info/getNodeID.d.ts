 ...
 * ```
 */
export declare function getNodeID<chain extends Chain | undefined>(client: Client<Transport, chain>): Promise<GetNodeIDReturnType>;
//# sourceMappingURL=getNodeID.d.ts.map