 ...
 * ```
 */
export declare function startCPUProfiler<chain extends Chain | undefined>(client: Client<Transport, chain>): Promise<void>;
//# sourceMappingURL=startCPUProfiler.d.ts.map