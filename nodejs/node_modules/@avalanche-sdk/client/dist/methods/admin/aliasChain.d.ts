 ...
 * ```
 */
export declare function aliasChain<chain extends Chain | undefined>(client: Client<Transport, chain>, params: AliasChainParameters): Promise<void>;
//# sourceMappingURL=aliasChain.d.ts.map