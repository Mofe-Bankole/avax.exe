 ...
 * ```
 */
export declare function setLoggerLevel<chain extends Chain | undefined>(client: Client<Transport, chain>, params: SetLoggerLevelParameters): Promise<void>;
//# sourceMappingURL=setLoggerLevel.d.ts.map