 ...
 * ```
 */
export declare function getTotalStake<chain extends Chain | undefined>(client: Client<Transport, chain>, params: GetTotalStakeParameters): Promise<GetTotalStakeReturnType>;
