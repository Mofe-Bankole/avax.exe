 ...
 * ```
 */
export declare function getBlockchainStatus<chain extends Chain | undefined>(client: Client<Transport, chain>, params: GetBlockchainStatusParameters): Promise<GetBlockchainStatusReturnType>;
//# sourceMappingURL=getBlockchainStatus.d.ts.map