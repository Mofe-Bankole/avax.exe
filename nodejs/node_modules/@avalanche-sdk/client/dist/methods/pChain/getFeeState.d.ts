 ...
 * ```
 */
export declare function getFeeState<chain extends Chain | undefined>(client: Client<Transport, chain>): Promise<GetFeeStateReturnType>;
//# sourceMappingURL=getFeeState.d.ts.map