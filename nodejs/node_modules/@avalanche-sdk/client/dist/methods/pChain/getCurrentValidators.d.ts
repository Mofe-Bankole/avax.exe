 ...
 * ```
 */
export declare function getCurrentValidators<chain extends Chain | undefined>(client: Client<Transport, chain>, params: GetCurrentValidatorsParameters): Promise<GetCurrentValidatorsReturnType>;
//# sourceMappingURL=getCurrentValidators.d.ts.map