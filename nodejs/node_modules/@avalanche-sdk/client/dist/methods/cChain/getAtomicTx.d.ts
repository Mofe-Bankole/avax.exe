 ...
 * ```
 */
export declare function getAtomicTx<chain extends Chain | undefined>(client: Client<Transport, chain>, params: GetAtomicTxParameters): Promise<GetAtomicTxReturnType>;
//# sourceMappingURL=getAtomicTx.d.ts.map