...
export type EditProfileInput = {
  walletAddress: string;           // used to find the user – NOT editable
  username?: string;
  avatar?: string | null;
  bio?: string | null;
  // Studio-only fields (will be ignored if role !== STUDIO)
  studioName?: string | null;
  studioDescription?: string | null;
  studioBannerUrl?: string | null;
  studioLogoUrl?: string | null;
  studioWebsite?: string | null;
  studioTwitter?: string | null;
